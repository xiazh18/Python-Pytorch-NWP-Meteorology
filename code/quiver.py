...
class Barbs(mcollections.PolyCollection):
    ...
    def _find_tails(self, mag, rounding=True, half=2, full=4, flag=20, fullflag=50):
        ...
        This returns a tuple of:
            ...
            (*number of fullflags*,*number of flags*, *number of barbs*, *half_flag*,*empty_flag*)
        ...
        *half_flag* is a boolean whether half of a barb is needed,
        ...
        half_flag = mag >= half
        empty_flag = ~(half_flag | (num_fullflags > 0) | (num_flags > 0) |(num_barb > 0))
    ...
    def _make_barbs(self, u, v, nfullflags, nflags,nbarbs, half_barb, empty_flag, length,pivot,                                sizes, fill_empty, flip):
        ...
        for index, angle in np.ndenumerate(angles):
            ...
            # Add vertices for each full flag #zhxia add code on 2023/2/21
            for i in range(nfullflags[index]):
                ...
                poly_verts.extend(
                    [[endx, endy + offset],
                     [endx + barb_height/4, endy - full_width / 8 + offset],
                     [endx, endy - full_width / 8 + offset],
                     [endx + barb_height/4, endy - full_width / 8 + offset],
                     [endx + barb_height/2, endy - full_width / 4 + offset],
                     [endx, endy - full_width / 4 + offset],
                     [endx + barb_height/2, endy - full_width / 4 + offset],
                     [endx + 3*barb_height/4, endy - 3*full_width / 8 + offset],
                     [endx, endy - 3*full_width / 8 + offset],
                     [endx + 3*barb_height/4, endy - 3*full_width / 8 + offset],
                     [endx + barb_height, endy - full_width / 2 + offset],
                     [endx,endy-full_width/2+offset],
                     [endx + barb_height, endy - full_width / 2 + offset],
                     [endx + 3*barb_height/4, endy - 5*full_width / 8 + offset],
                     [endx, endy - 5*full_width / 8 + offset],
                     [endx + 3*barb_height/4, endy - 5*full_width / 8 + offset],
                     [endx + barb_height/2, endy - 3*full_width / 4 + offset],
                     [endx, endy - 3*full_width / 4 + offset],
                     [endx + barb_height/2, endy - 3*full_width / 4 + offset],
                     [endx + barb_height/4, endy - 7*full_width / 8 + offset],
